...
contract sFAO is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked DAO Finance", "sFAO", 9) ERC20Permit() {
    ...
    /**
        @notice increases sFAO supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sFAO
